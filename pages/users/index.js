        ...
        <div className="bg-white h-auto rounded-lg px-8 py-8">
          <div className="flex relative">
            <div className="w-full flex flex-wrap gap-4 content-start">
              <div className="bg-gray-400 flex-grow-0 overflow-hidden flex-[calc((96.5%-12px)/5)] rounded-md">
      ...
      <div className="mx-[50px] my-6 shadow-md ">
        <div className="bg-white h-auto rounded-lg px-8 py-8">
          ...
          <div>
            ...
            <div className="flex items-center">
            <h2 className="text-sm text-red-500 my-[2px]">ขั้นต่ำ 100 </h2><p className="px-2 text-sm">สูงสุด 100 - ทวีคูณละ 100</p>
            </div>  
          </div>
          <div>
            <div className="my-3">
